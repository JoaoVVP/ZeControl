...
<head>
    ...
    <title>ZeControl - Erro interno</title>
...
<body>
    <div class="text-center text-white">
        ...
        <h1 class="fw-bold" style="color:var(--ze-yellow);">500</h1>
        <h4 class="mb-2">Erro interno</h4>
        <p class="text-muted mb-4">Algo deu errado. Tente novamente em instantes.</p>
        @auth
